...
#        self.forest_view.setSizePolicy(QSizePolicy.Minimum, QSizePolicy.Minimum)
    ...
    def paintGrid(self):
        ...
        print("START")
        print(view.rubberBandRect())
        print(view.sceneRect())
        print(group.frameGeometry())
        print(rect)
        print(rect2)
...
#        group.setGeometry(0,0,w,h)
        view.setSceneRect(0, 0, w, h)
        drect = QRectF(0, 0, w, h)
        #setSceneRect, setGeometry?
        scene.clear()
